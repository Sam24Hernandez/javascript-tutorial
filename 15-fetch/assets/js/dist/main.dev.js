...
function initialize(products) {
  ...
  function fetchBlob(product) {
    ...
    var url = "images/" + product.image; // Use fetch to fetch the image, and convert the resulting response to a blob
    ...
    fetch(url).then(function (response) {
      ...
      var objectURL = URL.createObjectURL(blob); // invoke showProduct
  ...
  function showProduct(objectURL, product) {
    ...
    image.src = objectURL;
    image.alt = product.name; // append the elements to the DOM as appropriate, to add the product to the UI

...
list.innerHTML = '';
var saludos = ['Feliz Cumpleaños', 'Feliz Navidad mi amor', 'Una Feliz Navidad para toda tu familia', 'Eres todo lo que quiero para mi Navidad', 'Nos vemos pronto'];

for (var i = 0; i < saludos.length; i++) {
  var input = saludos[i]; // Inserta tu solución aqui
...
list.innerHTML = '';
var ciudades = ['lonDon', 'ManCHESTer', 'BiRmiNGHAM', 'liVERpoOL'];

for (var i = 0; i < ciudades.length; i++) {
  var input = ciudades[i]; // Solucion
...
list.innerHTML = '';
var estaciones = ['MAN675847583748sjt567654;Manchester Piccadilly', 'GNF576746573fhdg4737dh4;Greenfield', 'LIV5hg65hd737456236dch46dg4;Liverpool Lime Street', 'SYB4f65hf75f736463;Stalybridge', 'HUD5767ghtyfyr4536dh45dg45dg3;Huddersfield'];

for (var i = 0; i < estaciones.length; i++) {
  var input = estaciones[i]; // Solucion
